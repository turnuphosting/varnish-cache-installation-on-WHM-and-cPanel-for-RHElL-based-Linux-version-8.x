...
sed -i '/sub vcl_recv {/,+5d' /etc/varnish/default.vcl
...
sed -i '/sub vcl_hash {/,+5d' /etc/varnish/default.vcl
cat >> /etc/varnish/default.vcl <<EOL
sub vcl_hash {
    if(req.http.X-Forwarded-Proto) {
...
sed -i '/sub vcl_backend_response {/,+5d' /etc/varnish/default.vcl
cat >> /etc/varnish/default.vcl <<EOL
...
sed -i '/sub vcl_deliver {/,+5d' /etc/varnish/default.vcl
cat >> /etc/varnish/default.vcl <<EOL
sub vcl_deliver {
